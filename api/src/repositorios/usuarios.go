...
// buscar traz todos ou usuarios que atendem um filtro de nome ou nick
...
// Atualizar altera as informações no banco de dados
...
//Seguir faz com que um usuario siga o outro
func (repositorio usuarios) Seguir(usuarioID, seguidorID uint64) error {
	statement, erro := repositorio.db.Prepare(
		"insert ignore int seguidores (usuari_id, seguidor_id) values(?, ?)",
	)
	if erro != nil {
		return erro
	}
...
//PararDeSeguirUsuario faz com que um usuario pare de seguir outro
